...
LOOKBACK_HOURS = 24  # 휴장일 대비 24시간으로 확장


# ===== 한국 휴장일 감지 =====
def is_kr_market_open(dt):
    """한국 증시 개장일 여부 (주말만 체크, 공휴일은 단순화)"""
    return dt.weekday() < 5  # 월~금
...
def fetch_dart_disclosures():
    """DART OpenAPI로 한국 상장사 공시 가져오기 (DART_API_KEY 필요)"""
